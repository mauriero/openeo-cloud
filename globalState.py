...
stateDict={
    ...
    # Timestamp (epoch seconds) of last detected solar surplus after reservation
    "eo_last_solar_surplus_ts": 0,

    # Whether a solar top-up is currently active (grid maintaining minimum current)
    "eo_solar_topup_active": False,
